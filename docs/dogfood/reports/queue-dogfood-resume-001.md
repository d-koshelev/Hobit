...
- Resume status: `provider_readiness_blocked`
...
- launch log: `C:\Users\Dmitry\Documents\prj\Hobit_queue_logic\target\hobit-dogfood\operator-launch\hobit-desktop-20644-2026-06-29T13-46-44-664Z.log`
...
- selected pack task id: `dogfood-file-import-hardening`
- selected Queue task id: `queue_task_prompt_pack_1782673287717489200_4`
- runLinkId: `not available`
- launch status: `provider_readiness_blocked`
- completion status: `provider_readiness_blocked`
- completion bridge terminalized run: true
- dependent task auto-started: false

## Accepted Dependencies

- `dogfood-foundation-checkpoint` -> `queue_task_prompt_pack_1782673287717627000_5` (succeeded)
