...
```powershell
node scripts/hobit/run-queue-dogfood-operator.mjs --dogfood-plan --json --report docs/dogfood/reports/queue-dogfood-plan-002.md
```
...
- launch log: `C:\Users\Dmitry\Documents\prj\Hobit_queue_logic\target\hobit-dogfood\operator-launch\hobit-desktop-7376-2026-06-30T20-38-49-934Z.log`
