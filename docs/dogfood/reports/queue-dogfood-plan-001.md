...
```powershell
node scripts/hobit/run-queue-dogfood-operator.mjs --dogfood-plan --json --report docs/dogfood/reports/queue-dogfood-plan-001.md
```
...
- launch log: `C:\Users\Dmitry\Documents\prj\Hobit_queue_logic\target\hobit-dogfood\operator-launch\hobit-desktop-28484-2026-06-29T22-16-06-482Z.log`
