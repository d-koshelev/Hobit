...
```powershell
node scripts/hobit/run-queue-dogfood-operator.mjs --dogfood-plan --json --report docs/dogfood/reports/queue-dogfood-plan-003.md
```
...
- launch log: `C:\Users\Dmitry\Documents\prj\Hobit_queue_logic\target\hobit-dogfood\operator-launch\hobit-desktop-8428-2026-06-30T20-39-36-781Z.log`
