...
- Agent run observability views defined in `docs/AGENT_RUN_OBSERVABILITY_CONTRACT.md` currently exist only as the Agent Monitoring read-only viewer for Agent Chat proposal-only artifacts; real run observability is not implemented.
