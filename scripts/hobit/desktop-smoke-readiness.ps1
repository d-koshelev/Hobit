...
function Show-Help {
    ...
    Write-Host "If PowerShell blocks direct .ps1 invocation, use:"
    Write-Host "  powershell -NoProfile -ExecutionPolicy Bypass -File scripts/hobit/desktop-smoke-readiness.ps1 -Reset"
    Write-Host ""
    Write-Host "Options:"
...
Write-Host "  Launch markers verify startup only. They are not a desktop UI smoke pass."
Write-Host ""
...
Write-Host "    scripts/hobit/DESKTOP_SMOKE_CHECKLIST.md"
Write-Host ""
