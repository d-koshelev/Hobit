...
pub use workspace_service::{
    ...
    AgentQueueTaskRunSummary, AgentQueueTaskSummary, AssignAgentQueueTaskToExecutorInput,
    ...
    CreateJdbcConnectorInput, CreateKnowledgeDocumentInput, CreateSkillInput,
    CreateWorkspaceNoteInput, DeleteAgentQueueTaskInput, DeleteKnowledgeDocumentInput,
    DeleteSkillInput, DirectWorkValidationRunSummary, ExecuteJdbcReadOnlyQueryInput,
    ...
    GitLogSummary, GitRepositoryStatusSummary, GitWorkingTreeStatusSummary, JdbcConnectorSummary,
    JdbcExperimentalSidecarRuntimeInput, JdbcQueryColumnSummary, JdbcReadOnlyQueryResultSummary,
    JdbcReadOnlySqlValidationSummary, KnowledgeDocumentSearchResultSummary,
    KnowledgeDocumentSummary, MockCoordinatorProviderAdapter, PersistAgentChatProposalInput,
