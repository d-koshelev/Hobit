...
pub use workspace_service::{
    ...
    CreateWorkspaceNoteInput, DirectWorkValidationRunSummary, GenerateAgentChatAiProposalInput,
    ...
    TerminalCommandRunSummary, UpdateAgentQueueTaskInput, UpdateWorkspaceNoteInput,
