...
export const themePresets: ThemePreset[] = [
  ...
  {
    id: "industrial-cockpit",
    mode: "dark",
    name: "Industrial Cockpit",
    variables: {
      "--hb-accent-primary": "#f5a524",
      "--hb-accent-primary-hover": "#ffb83d",
      "--hb-accent-primary-muted": "#6b4318",
      "--hb-accent-primary-subtle": "#342411",
      "--hb-bg-app": "#0c0f0f",
      "--hb-bg-canvas": "#090b0b",
      "--hb-bg-topbar": "#111413",
      "--hb-border-default": "#30352f",
      "--hb-border-strong": "#4b5147",
      "--hb-border-subtle": "#232821",
      "--hb-status-error": "#ff6b57",
      "--hb-status-error-bg": "#3d1d19",
      "--hb-status-info": "#d9b96e",
      "--hb-status-info-bg": "#302818",
      "--hb-status-neutral": "#94988d",
      "--hb-status-neutral-bg": "#272a25",
      "--hb-status-success": "#6fd16f",
      "--hb-status-success-bg": "#1b3521",
      "--hb-status-warning": "#f6c64b",
      "--hb-status-warning-bg": "#3c3115",
      "--hb-surface-input": "#121715",
      "--hb-surface-output": "#060807",
      "--hb-surface-panel": "#171a18",
      "--hb-surface-panel-raised": "#20251f",
      "--hb-surface-widget": "#131715",
      "--hb-surface-widget-raised": "#1a1f1b",
      "--hb-text-disabled": "#666961",
      "--hb-text-muted": "#9b998d",
      "--hb-text-primary": "#f4f1df",
      "--hb-text-secondary": "#d2ccb8",
    },
  },
];
