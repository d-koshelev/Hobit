...
export const themePresets: ThemePreset[] = [
  ...
  },
  {
    ...
    name: "Discord Dark",
    variables: {
      "--hb-accent-primary": "#5865F2",
      "--hb-accent-primary-hover": "#4752C4",
      "--hb-accent-primary-muted": "#3f4db8",
      "--hb-accent-primary-subtle": "#343761",
      "--hb-bg-app": "#1e1f22",
      "--hb-bg-canvas": "#232428",
      "--hb-bg-topbar": "#1e1f22",
      "--hb-border-default": "#3f4147",
      "--hb-border-strong": "#4e5058",
      "--hb-border-subtle": "#36383f",
      "--hb-status-error": "#ed4245",
      "--hb-status-error-bg": "#3f2528",
      "--hb-status-info": "#5865F2",
      "--hb-status-info-bg": "#2e335f",
      "--hb-status-neutral": "#949ba4",
      "--hb-status-neutral-bg": "#34363c",
      "--hb-status-success": "#3ba55d",
      "--hb-status-success-bg": "#25382b",
      "--hb-status-warning": "#f0b232",
      "--hb-status-warning-bg": "#3d331f",
      "--hb-surface-input": "#232428",
      "--hb-surface-output": "#1a1b1e",
      "--hb-surface-panel": "#2b2d31",
      "--hb-surface-panel-raised": "#313338",
      "--hb-surface-widget": "#2b2d31",
      "--hb-surface-widget-raised": "#313338",
      "--hb-text-disabled": "#6d717a",
      "--hb-text-muted": "#949ba4",
      "--hb-text-primary": "#dbdee1",
      "--hb-text-secondary": "#b5bac1",
    },
  },
  {
    id: "graphite",
