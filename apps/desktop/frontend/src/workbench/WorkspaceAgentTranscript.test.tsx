...
function renderTranscript(overrides: Partial<TranscriptProps> = {}) {
  const props: TranscriptProps = {
    ...
    onCreateQueueTaskFromReportCard: vi.fn(),
    onCreateSkill: vi.fn(),
    onDiscardQueueIntentDraft: vi.fn(),
    onEditProposal: vi.fn(),
    onPatchQueueReportCard: vi.fn(),
    onPatchQueueIntentDraft: vi.fn(),
    onQueueActionResult: vi.fn(),
    onQueueReportActionResult: vi.fn(),
