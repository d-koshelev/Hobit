...
export function diffReviewTaskPromptFromReportCard(
  ...
  return [
    ...
    "- Do not modify code, finalize the source item, run validation, execute rollback, unblock dependents, or mutate Git.",
    "",
    ...
    `- Source report ref: ${card.sourceReportId}`,
    ...
    `- Source validation status: ${card.sourceValidationStatus ?? "not recorded"}`,
    "",
    "Checklist:",
    ...
    "- No hidden commit, push, finalize, rollback, or dependency unblock",
    "",
