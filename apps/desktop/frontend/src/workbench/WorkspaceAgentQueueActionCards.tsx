...
export function WorkspaceAgentQueueActionPanel({
  ...
  return (
    ...
    >
      <summary className="workspace-agent-queue-actions-summary">
        Queue tools
      </summary>

      <div className="workspace-agent-queue-actions-body">
        <div className="workspace-agent-queue-actions-header">
          <div>
            ...
            <p className="coordinator-proposal-note">
              Secondary Queue inspect/create/update controls. Chat commands and
              active cards stay in the conversation.
            </p>
          </div>
