...
} from "./knowledgeContextAffordances";
import { knowledgeV2ContextText, knowledgeV2ReferenceText } from "./knowledgeContextAffordances";
import type { KnowledgeV2CatalogItem } from "../model/knowledgeCatalogTypes";
import {
  KnowledgeV2StatusBadge,
  knowledgeV2ItemStatuses,
} from "../components/KnowledgeItemStatus";
