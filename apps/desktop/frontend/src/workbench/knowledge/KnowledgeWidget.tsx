...
import { WidgetV2Shell } from "../widgetV2/WidgetV2Shell";
import {
  KnowledgeV2Actions,
  type KnowledgeV2ActionAvailabilityMap,
} from "./components/KnowledgeActions";
import { KnowledgeV2CatalogBrowser } from "./components/KnowledgeCatalogBrowser";
import { KnowledgeV2DebugContent } from "./debug/KnowledgeDebugContent";
import { buildKnowledgeV2DebugModel } from "./debug/knowledgeDebugModel";

export type KnowledgeWidgetProps = {
...
export const KnowledgeV2Widget = KnowledgeWidget;
export type KnowledgeV2WidgetProps = KnowledgeWidgetProps;
