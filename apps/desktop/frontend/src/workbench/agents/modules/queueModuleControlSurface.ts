...
export const QUEUE_MODULE_CONTROL_SURFACE: ModuleControlSurface<QueueCapabilityRiskClass> =
  {
    ...
    compatibilityNotes: [
      ...
      "Queue workflow requests can invoke QueueWorkflowRunner for supported explicit read, review, and finalization phases through injected typed runtime ports.",
    ...
    contractTestRequirements: [
      ...
      "Queue workflows must not be marked runtime_available until durable workflow run state exists; current runtime wiring is limited to explicit read/review/finalization runner phases.",
