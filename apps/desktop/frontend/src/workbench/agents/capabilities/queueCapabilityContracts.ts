...
export const QUEUE_CAPABILITY_CONTRACT_INVENTORY: readonly QueueCapabilityContract[] =
  [
    ...
    queueContract({
      ...
      fieldPolicies: {
        expectedVersion: "model_optional_exact_only",
    ...
    queueContract({
      ...
      fieldPolicies: {
        limit: "model_optional",
        status: "model_optional_exact_only",
        workflowId: "model_optional_exact_only",
        workspaceId: "model_optional_exact_only",
      },
      nextSuggestedCapabilities: [
        "queue.workflow.get",
    ...
    queueContract({
      ...
      nextSuggestedCapabilities: ["queue.workflow.getReport"],
      readOnly: true,
      riskClass: "read",
      sideEffectLevel: "read",
      trustedContextFields: RUNTIME_CONTEXT_FIELDS,
