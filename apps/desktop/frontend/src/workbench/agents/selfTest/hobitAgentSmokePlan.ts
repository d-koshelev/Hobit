...
function queueDogfoodBrokerPlanCases(): HobitAgentSmokeCase[] {
  return [
    ...
    smokeCase({
      ...
      componentTitle: "Queue dogfood broker loop",
      expectedResultDescription:
        "Queue-linked Direct Work completion can feed evidence ingestion only through explicit metadata, matching Agent Executor run detail, and the Action Broker path.",
      kind: "capability-dry-run",
      required: false,
      safeMode: "metadata-only",
      source: "Action Broker Queue dogfood self-test",
    ...
    smokeCase({
      ...
      componentTitle: "Queue dogfood broker loop",
      expectedResultDescription:
        "Raw Workspace Agent, raw Direct Work, Agent Activity, and standalone Executor history do not feed evidence ingestion without explicit Queue linkage.",
      kind: "capability-dry-run",
      required: false,
      safeMode: "metadata-only",
      source: "Action Broker Queue dogfood self-test",
    ...
    smokeCase({
      ...
      componentTitle: "Queue dogfood broker loop",
      expectedResultDescription:
        "Repeated Queue-linked completion events use the frontend current-session idempotency key and do not duplicate bridge calls.",
      kind: "capability-dry-run",
      required: false,
      safeMode: "metadata-only",
      source: "Action Broker Queue dogfood self-test",
