...
export const widgetV2Manifests: readonly WidgetV2Manifest[] = [
  ...
  },
  {
    ...
    actions: [
      {
        type: "knowledge-v2.new-placeholder",
        label: "New",
        description: "Placeholder only; no create action is wired in this shell.",
        requiresApproval: true,
        risk: "low",
      },
      {
        type: "knowledge-v2.import-placeholder",
        label: "Import",
        description: "Placeholder only; no import action is wired in this shell.",
        requiresApproval: true,
        risk: "low",
      },
      {
        type: "knowledge-v2.draft-review-placeholder",
        label: "Draft Review",
        description: "Placeholder only; no draft review action is wired in this shell.",
        requiresApproval: true,
        risk: "low",
      },
      {
        type: "knowledge-v2.manage-skills-placeholder",
        label: "Manage Skills",
        description: "Placeholder only; no Skill management action is wired in this shell.",
        requiresApproval: true,
        risk: "low",
      },
    ],
    ...
    runtimeLimitations: [
      "No data integration is granted by the manifest.",
      "No team/server knowledge runtime is granted.",
      "No indexing or search backend is granted.",
    ],
    nonGoals: [
      "No hidden ingestion.",
