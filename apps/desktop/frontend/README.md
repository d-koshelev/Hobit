...
- Script Runner UI, catalog insertion, script execution, backend execution, Tauri commands, storage, or runtime behavior.
...
- Real Docking Station widget parking, station persistence, drag-and-drop, presence-zone storage, or per-widget Indicator status providers.
