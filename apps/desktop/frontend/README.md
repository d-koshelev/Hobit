...
- Template storage, template editing, request generation, response parsing, response validation, executor launch, or agent execution from the Template Library placeholder.
- Preset persistence.
