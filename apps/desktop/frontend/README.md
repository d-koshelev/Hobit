...
- Template storage, template editing, variable filling, request generation, copy/send behavior, response parsing, response validation, executor launch, or agent execution from the Template Library placeholder.
- Preset persistence.
