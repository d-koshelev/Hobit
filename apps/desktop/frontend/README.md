...
- Git command execution, repository-root validation or persistence, repository access, diff parsing, validation association, staging, commit, push, revert/reset, or background watching.
- Preset persistence.
