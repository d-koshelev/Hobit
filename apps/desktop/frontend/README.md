...
- Repository-root persistence, status persistence, polling, background watching, diff parsing, validation association, staging, commit, push, revert/reset, clean, stash, or other Git mutations.
- Preset persistence.
