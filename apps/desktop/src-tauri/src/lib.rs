...
pub fn run() {
    tauri::Builder::default()
        ...
        .invoke_handler(tauri::generate_handler![
            ...
            agent_queue_task_commands::attach_knowledge_to_queue_task,
            agent_queue_task_commands::detach_knowledge_from_queue_task,
            agent_queue_task_commands::attach_skill_to_queue_task,
            agent_queue_task_commands::detach_skill_from_queue_task,
