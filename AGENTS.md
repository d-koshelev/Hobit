...
- Coordinator Chat is the user-facing title for the existing `interactive-agent` local chat compatibility surface. It has no provider connection, Queue integration, monitoring integration, widget tool execution, or agent runtime.
