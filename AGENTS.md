...
- Add Widget opens the Widget Catalog drawer. The Notes, Terminal placeholder, Agent Chat placeholder, Agent Run placeholder, Git placeholder, and Template Library placeholder templates can be inserted as persisted WidgetInstances; other catalog items remain planned/display-only.
...
- Do not add widget insertion behavior beyond the existing Notes, Terminal placeholder, Agent Chat placeholder, Agent Run placeholder, Git placeholder, and Template Library placeholder catalog paths unless explicitly requested.
...
- additional widget insertion behavior beyond the existing Notes, Terminal placeholder, Agent Chat placeholder, Agent Run placeholder, Git placeholder, and Template Library placeholder paths
